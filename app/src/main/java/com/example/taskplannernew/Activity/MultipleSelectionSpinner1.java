...
class MultipleSelectionSpinner1 extends AppCompatSpinner implements
...
public MultipleSelectionSpinner1(Context context) {
        super(context);
...
public MultipleSelectionSpinner1(Context context, AttributeSet attrs) {
        super(context, attrs);
...
public void onClick(DialogInterface dialog, int which, boolean isChecked) {
        Log.i("onClick","which:"+which+":isChecked:"+isChecked);
        ...
        simple_adapter.add("Tap to select");
                ...
                Log.i("onClick","simple_adapter:"+simple_adapter);
        } else {
...
public  String buildSelectedItemString() {
        ...
        sbLength = sb.length();
        Log.i("onClick","sb.toString():"+sb.toString());
        return sb.toString();
        }
