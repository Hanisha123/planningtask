...
public class InProgressDetailActivity extends AppCompatActivity {
       ...
       // taskid = getIntent().getExtras().getString("task_id");
        ...
        reassign_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent reassign_task = new Intent(InProgressDetailActivity.this,Re_Assign_Activity.class);
        ...
        changetat_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent changetat = new Intent(InProgressDetailActivity.this,ChangeTATActivity.class);
        ...
        fab_addactivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent addactivity = new Intent(InProgressDetailActivity.this,AddActivity_Activity.class);
        ...
        fabLayout_reopen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(InProgressDetailActivity.this);
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                InProgressDetailActivity recentTaskDetails = new InProgressDetailActivity();
    ...
    /*    if(taskstatus.equals("PENDING") || taskstatus.equals("ON-PROCESS"))
        ...
        else
        {
            ...
            (Toast.makeText(InProgressDetailActivity.this, "You are not Manager as well as Executive", Toast.LENGTH_SHORT)).show();
        }
                ...
                try {
                    ...
                    if (actalltask.getMessage().equalsIgnoreCase("success")) {
                        ...
                        if(actalltask.getDataTaskActivity()==null){
                            ...
                            Toast.makeText(InProgressDetailActivity.this,"There is no Data Task Activities",Toast.LENGTH_SHORT).show();
                            ...
                            adapter = new AllTaskAdapter(activityTaskModelArrayList, InProgressDetailActivity.this);
                            recyclerView.setLayoutManager(new LinearLayoutManager(InProgressDetailActivity.this));
                        ...
                        globalProgressDialog.dismissProgressDialog();
                        Toast.makeText(InProgressDetailActivity.this, actalltask.getMessage(), Toast.LENGTH_SHORT).show();
                    }
            ...
            try {
                ...
                if (response.contains("Task has been reopen")) {
                    activity.runOnUiThread(new Runnable() {
                        public void run() {
                            globalProgressDialog.dismissProgressDialog();
                            Toast.makeText(InProgressDetailActivity.this, "Task has been reopen.", Toast.LENGTH_SHORT).show();

                        }
                    });
                } else {
                    globalProgressDialog.dismissProgressDialog();
                    Toast.makeText(InProgressDetailActivity.this, "Something went wrong.", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                if (response.contains("Task has been approved")) {
                    activity.runOnUiThread(new Runnable() {
                        public void run() {
                            globalProgressDialog.dismissProgressDialog();
                            Toast.makeText(InProgressDetailActivity.this, "Task has been approved", Toast.LENGTH_SHORT).show();
